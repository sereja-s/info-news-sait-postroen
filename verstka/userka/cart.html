...
<body>
  ...
  <section class="cart-page">
    <div class="container">
          ...
          <div class="cart-page__item">
            <div class="cart-page__item-left">
              <div class="cart-page__item-image">
                <a href="#">
                  <img class="cart-page__item-img" src="img/cart-img-1.jpg" alt="">
                </a>
              </div>

              <div class="cart-page__item-content">
                <h2 class="cart-page__item-title"><a href="#">Холодильник Electrolux EWH 80 Formax</a></h2>

                <p class="cart-page__item-code">Код товара: 519868.0</p>

                <div class="cart-page__item-other-service">
                  <div class="cart-page__os-title">Дополнительный сервис</div>

                  <div class="cart-page__os-change">
                    Нет
                  </div>
                </div>
              </div>
            ...
            <div class="cart-page__item-right">
              <div class="cart-page__item-num">
                <a href="#" class="cart-page__item-minus">-</a>

                <div class="cart-page__item-form">
                  <input class="cart-page__item-input" type="text" value="1">
                </div>

                <a href="#" class="cart-page__item-plus">+</a>
              </div>

              <div class="cart-page__item-price">
                <p class="cart-page__price-num">7 600 грн</p>
                <s class="cart-page__price-s-num">10 399</s>
        ...
        <div class="cart-page__right">
          <div class="cart-page__info">
            ...
            <div class="cart-page__total-item">
              <p>Товаров,&nbsp;&nbsp;3шт</p>
              <p><span>37 800 грн</span></p>
            </div>

            <div class="cart-page__total-item">
              <p>Скидка</p>
              <p><span class="cart-page__ti-red">7000 грн</span></p>
            </div>
            ...
            <div class="cart-page__delivery-date">
              <p><b>Доставка</b></p>
              <p>04.05.2022 &nbsp;&nbsp;&nbsp;10:00-18:00</p>
            </div>

            <div class="cart-page__delivery-button">
              <button class="cart-page__delivery-button-link">Оформить заказ</button>
            </div>
          </div>
        </div>
      ...
      <div class="cart-page__get-delivery">
